        ...
        <div class="container">
            <div class="row align-items-sm-center">
                <div class="col-sm-2 col-5">
                    <a href="https://edge.clinic"><img src="https://edge.clinic/wp-content/uploads/2025/06/edge_logo.png" alt="Edge Clinic Logo" class="img-fluid" width="130"></a>
                </div>
                <div class="col-sm-9 col-5">
                    <nav class="navbar navbar-expand-lg p-0">
                      <div class="container-fluid p-0 justify-content-end">
                       ...
                       @php
    $currentHost = parse_url(url()->current(), PHP_URL_HOST);
    $homeHosts = ['edge.clinic', 'www.edge.clinic'];
@endphp
        ...
        For Patients
                ...
                <div class="col-sm-1 col-2 px-sm-3 px-0">
                    <div class="whatsappicon-wrapper">
                        <a href="https://api.whatsapp.com/send?phone=919392585050" target="_blank"><img src="{{ asset('assets/img/WhatsApp.png')}}" alt="whatsapp" class="img-fluid"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div>
                    ...
                    <ul class="mt-3 mb-3">
                        <li><a href="tel:+91 9392585050"><i class="fa-solid fa-phone"></i> &nbsp; &nbsp; +91 9392585050</a></li>
