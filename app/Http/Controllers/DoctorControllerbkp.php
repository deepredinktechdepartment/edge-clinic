...
class DoctorController extends Controller
{
    public function doctors_list()
    {
        ...
        $doctors_data=Doctor::leftjoin('departments','departments.id','=','doctors.department_id')->orderBy('doctors.name','ASC')->get(['doctors.*','departments.dept_name']);
